  ...
  return (
    <>
      <div className={styles.navibar}>
        ...
        <div
          className={isLogoutVisible ? styles.logoutBtn : styles.hide}
          onClick={() => logOut()}
        >
          Выйти из аккаунта
        </div>
        ...
        <div className={styles.nav}>
          ...
          >
            <img
              src={
                activePage === 1 ? "/img/activeDishes.png" : "/img/dishes.png"
              }
              alt='dishes'
              width={25}
              height={25}
          ...
          >
            <img
              src={
                activePage === 2 ? "/img/activeOrders.png" : "/img/orders.png"
              }
              alt='orders'
              width={25}
              height={25}
